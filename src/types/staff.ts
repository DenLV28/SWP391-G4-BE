...
export const initialGates: Gate[] = [
  { id: 'A1', name: 'Cổng A1', location: 'Lối vào phía Bắc', camLabel: 'CAM_R_ENTRANCE', active: true, state: 'closed' },
  { id: 'A2', name: 'Cổng A2', location: 'Cổng phía Nam', camLabel: 'CAM_A2_EXIT', active: true, state: 'closed' },
];
